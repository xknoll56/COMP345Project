...
Map::Map(int numContinents, int numTerritories) {
	territoriesCapacity = numTerritories;
	continentsCapacity = numContinents;
...
Territory* Map::CreateTerritory(std::string name, Continent* continent) {
	...
	if (territories.size() < territoriesCapacity)
	{
	...
	std::cout << "No more room for territories, returning a null pointer." << std::endl;
	return nullptr;
}

Continent* Map::CreateContinent(std::string name, int bonus) {
	if (continents.size() < continentsCapacity)
	{
	...
	std::cout << "No more room for continent, returning a null pointer." << std::endl;
	return nullptr;
}
